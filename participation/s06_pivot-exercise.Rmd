...
#id_cols are the data we want to keep 
#names_from tells which columns we are taking the names from 
#values_from tells r where we get the values from
```
