...
ng_data <- ng_data %>% 
  ...
  mutate(
    green_tot_pomp = mean(
    c(green1_pomp,green2_pomp,green3_pomp,green4_pomp,green5_pomp), na.rm = TRUE),
         comp_tot_pomp = mean(
           c(comp1_pomp,comp2_pomp,comp3_pomp,comp4_pomp,comp5_pomp,comp6_pomp,comp7_pomp,comp8_pomp,comp9_pomp,comp10_pomp), na.rm = TRUE),
         intel_tot_pomp = mean(
           c(intel1_pomp,intel2_pomp,intel3_pomp,intel4_pomp,intel5_pomp,intel6_pomp,intel7_pomp,intel8_pomp,intel9_pomp,intel10_pomp), na.rm = TRUE),
         open_tot_pomp = mean(
           c(open1_pomp,open2_pomp,open3_pomp,open4_pomp,open5_pomp,open6_pomp,open7_pomp,open8_pomp,open9_pomp,open10_pomp), na.rm = TRUE),) 
...
```{r}
ggplot(ng_data_pomp[which(ng_data_pomp$green_tot_pomp>0),]) +
  aes(green_tot_pomp) +
